...
The repository includes the full pipeline: dataset extraction, preprocessing, data augmentation, model training, and evaluation. The project is implemented in PyTorch and follows a modular design.
